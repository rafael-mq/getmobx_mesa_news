...
class AuthApi {
  ...
  /// Authenticate user with [data] fields and completes with User instance.
  ...
  /// Register user with [data] fields and completes with User instance.
  Future<User> register(Map<String, String> data) async {
    try {
      print("register data -> $data");
      Response resp = await _client.post("$_url/signup", data: data);
      print("received -> ${resp.data}");
      return User(
        email: data["email"],
        password: data["password"],
